...
namespace dotNetFractal.Uno.ViewModels
{
    public class MainViewModel : BaseViewModel, IDisposable
    {
        ...
        public ColorMapViewModel ColorMap
        {
            get => m_colorMap;
            set
            {
                if (ReferenceEquals(m_colorMap, value))
                {
                    return;
                }
        ...
        public DisplaySettingsViewModel DisplaySettings
        {
            get => m_displaySettings;
            set
            {
                if (ReferenceEquals(m_displaySettings, value))
                {
                    return;
                }
